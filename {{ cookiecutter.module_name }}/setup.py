...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:{{ cookiecutter.download }}/trytond-{{ cookiecutter.module_name }}.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-{{ cookiecutter.module_name }}.git'
    },
    classifiers=[
